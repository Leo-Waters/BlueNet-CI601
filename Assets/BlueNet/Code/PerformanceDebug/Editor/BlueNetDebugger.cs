 ...
 * 
 *  Script: BlueNet Debbugger and performance logger
    ...
    public class BlueNetDebugger : EditorWindow
    {
            ...
            while (true)
            {
                LoggingThread = new Thread(() =>
                {
                    ...
                    while (isLogging)
                    {
                        ...
                        TimeElapsed++;
                        writer.WriteLine(string.Format("{0} {1} {2} {3} {4}", sentBytes, recivedBytes, objectUpdates, currentFPS, (int)MathF.Round(BlueNetManager.ping * 1000)));
        ...
        private void OnGUI()
        {
            ...
            if (isLogging&& BlueNetManager.Instance != null)
            {
                ...
                GUILayout.Label("Ping: "+ BlueNetManager.ping * 1000+" ms");
